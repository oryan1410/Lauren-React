...
const Beers = () => {
    ...
    const { alcoholArr, whiskeyArr, americanArr, smokedArr, coniacArr, vodkaArr, rumArr, ginArr, taquillaArr, apperativoArr, anisArr, cocktailsArr,beerArr, countries, getFilters, isLoading } = useUserContext();
